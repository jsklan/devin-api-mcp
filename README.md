...
```bash
git clone https://github.com/YOUR_ORG/devin-api-mcp.git
cd devin-api-mcp
npm install
```
...
```bash
claude mcp add -s user -e DEVIN_API_KEY=your_key_here devin-api node /absolute/path/to/devin-api-mcp/index.js
```
